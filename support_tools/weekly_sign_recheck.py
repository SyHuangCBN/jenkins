...
def TriggerJenkins7465_PA(search,searchfile):
	...
	os.popen("echo '%s' > ~/cbn/dailytimeout/%s/timeout7465.txt" % (times,localtimes)).readlines()    
        os.system("curl -u admin:1efb06decbc9a2daceb595da61a555d6 http://10.118.252.30:8080/job/DailyBuild_CH7465CE/build?token=weeklybuild7465")
        sys.exit(1)
    else:
...
def TriggerJenkins7465_P7(search,searchfile):
    ...
    time.sleep(60)
    print 'Restart Trigger CH7465LG DailyBuild'
    os.system("curl -u admin:1efb06decbc9a2daceb595da61a555d6 http://10.118.252.30:8080/job/DailySign_CH7465CE/build?token=weeklysign7465")
...
searchlist = {'ch8568qePA':'CH8568LG-NCIP-*-%s-SH-PA'%localtimes,'ch7465cePA':'CH7465LG-NCIP-*-%s-W-SH-PA'%localtimes,'ch8568qep7':'CH8568LG-NCIP-*-%s-SH-PA.NNEMN.p7'%localtimes,'ch7465cep7':'CH7465LG-NCIP-*-%s-W-SH-PA.NNEMN.p7'%localtimes}
